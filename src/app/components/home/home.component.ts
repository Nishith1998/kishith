...
export class HomeComponent {
  eventList: { label: string, routePath: string, svgPath: string, backgroundImage: string, width?: string }[] = [
    ...
    { label: "Mandap Ropan", routePath: "/mandapRopan", width: 'h-14', svgPath: "https://media-public.canva.com/jnf8k/MAEkPCjnf8k/1/tl.png", backgroundImage: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmvTWPPFsD74lbYl24s1YoxVoZheUf6oOuQP5IMD3HpKD3VEgFJDYZXgmWP0VEjpBwZV4&usqp=CAU" },
